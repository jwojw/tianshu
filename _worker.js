...
//////////////////////////////////////////////////////////////////////////配置区块////////////////////////////////////////////////////////////////////////
let 哎呀呀这是我的ID啊 = "kang"; //实际上这是你的订阅路径，支持任意大小写字母和数字，[域名/ID]进入订阅页面
let 哎呀呀这是我的VL密钥 = "fffcd11a-5468-4536-a5ea-977cf6d0fb09"; //这是真实的UUID，通用订阅会进行验证，建议修改为自己的规范化UUID
...
let 我的优选 = [
  '104.26.12.197',
  '104.26.11.200',
  '[2a06:98c1:3121:ca8a:ef16:b32f:cb43:6e79]',
  '[2a06:98c1:3120:ec18:532f:3e2c:660:5308]',
...
let 反代IP = 'proxyip.tp27231.hbmc.net' //反代IP或域名，反代IP端口一般情况下不用填写，如果你非要用非标反代的话，可以填'ts.hpc.tw:443'这样
